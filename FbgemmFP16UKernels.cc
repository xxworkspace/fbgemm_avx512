...
void __attribute__((noinline)) gemmkernel_1x2_AVX256_fA0fB0fC0(GemmParams* gp) {
  asm volatile(
      ...
      // beta
      "vbroadcastss ymm14,DWORD PTR [r15]\t\n"
      ...
      "vcvtph2ps ymm15,XMMWORD PTR [r10 + r11 + 0]\t\n"
      ...
      "vfmadd231ps ymm0,ymm14,YMMWORD PTR [r12 + 0]\t\n"
      "vmovups YMMWORD PTR [r12 + 0], ymm0\t\n"
      "vfmadd231ps ymm1,ymm14,YMMWORD PTR [r12 + 32]\t\n"
      "vmovups YMMWORD PTR [r12 + 32], ymm1\t\n"
      "add r12, r13\t\n"
...
void __attribute__((noinline)) gemmkernel_2x2_AVX256_fA0fB0fC0(GemmParams* gp) {
  asm volatile(
      ...
      // Dump C
      "vmovups YMMWORD PTR [r12 + 0], ymm0\t\n"
      "vmovups YMMWORD PTR [r12 + 32], ymm2\t\n"
      "add r12, r13\t\n"
      ...
      "vfmadd231ps ymm0,ymm14,YMMWORD PTR [r12 + 0]\t\n"
      "vmovups YMMWORD PTR [r12 + 0], ymm0\t\n"
      "vfmadd231ps ymm2,ymm14,YMMWORD PTR [r12 + 32]\t\n"
      "vmovups YMMWORD PTR [r12 + 32], ymm2\t\n"
      "add r12, r13\t\n"
      "vfmadd231ps ymm1,ymm14,YMMWORD PTR [r12 + 0]\t\n"
      "vmovups YMMWORD PTR [r12 + 0], ymm1\t\n"
      "vfmadd231ps ymm3,ymm14,YMMWORD PTR [r12 + 32]\t\n"
      "vmovups YMMWORD PTR [r12 + 32], ymm3\t\n"
      "add r12, r13\t\n"
...
void __attribute__((noinline)) gemmkernel_3x2_AVX256_fA0fB0fC0(GemmParams* gp) {
  asm volatile(
      ...
      "add r12, r13\t\n"
      "vmovups YMMWORD PTR [r12 + 0], ymm1\t\n"
      "vmovups YMMWORD PTR [r12 + 32], ymm4\t\n"
      "add r12, r13\t\n"
      ...
      "vfmadd231ps ymm1,ymm14,YMMWORD PTR [r12 + 0]\t\n"
      "vmovups YMMWORD PTR [r12 + 0], ymm1\t\n"
      "vfmadd231ps ymm4,ymm14,YMMWORD PTR [r12 + 32]\t\n"
      "vmovups YMMWORD PTR [r12 + 32], ymm4\t\n"
      "add r12, r13\t\n"
      "vfmadd231ps ymm2,ymm14,YMMWORD PTR [r12 + 0]\t\n"
      "vmovups YMMWORD PTR [r12 + 0], ymm2\t\n"
      "vfmadd231ps ymm5,ymm14,YMMWORD PTR [r12 + 32]\t\n"
      "vmovups YMMWORD PTR [r12 + 32], ymm5\t\n"
      "add r12, r13\t\n"
...
void __attribute__((noinline)) gemmkernel_4x2_AVX256_fA0fB0fC0(GemmParams* gp) {
  asm volatile(
      ...
      "add r12, r13\t\n"
      "vmovups YMMWORD PTR [r12 + 0], ymm2\t\n"
      "vmovups YMMWORD PTR [r12 + 32], ymm6\t\n"
      "add r12, r13\t\n"
      ...
      "vfmadd231ps ymm2,ymm14,YMMWORD PTR [r12 + 0]\t\n"
      "vmovups YMMWORD PTR [r12 + 0], ymm2\t\n"
      "vfmadd231ps ymm6,ymm14,YMMWORD PTR [r12 + 32]\t\n"
      "vmovups YMMWORD PTR [r12 + 32], ymm6\t\n"
      "add r12, r13\t\n"
      "vfmadd231ps ymm3,ymm14,YMMWORD PTR [r12 + 0]\t\n"
      "vmovups YMMWORD PTR [r12 + 0], ymm3\t\n"
      "vfmadd231ps ymm7,ymm14,YMMWORD PTR [r12 + 32]\t\n"
      "vmovups YMMWORD PTR [r12 + 32], ymm7\t\n"
      "add r12, r13\t\n"
